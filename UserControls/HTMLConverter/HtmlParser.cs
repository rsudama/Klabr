...
// the '>' character to be used in attribute values, but it can still be used as an entity. 2) Maintain a HTML-specific item
...
// and store it in the item of already-read content, and then open a new element to which all tags that are currently open
...
namespace HTMLConverter
{
    ...
    internal class HtmlParser
    {
        ...
        private XmlElement ParseHtmlContent()
        {
            ...
            // We create "html" element which may be a duplicate of real HTML element, 
            // which is ok, as HtmlConverter will swallow it painlessly..
