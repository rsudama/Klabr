...
namespace HTMLConverter
{
    ...
    internal class HtmlSchema
    {
        ...
        static HtmlSchema()
        {
            // initializes the item of all html elements
            ...
            // initialize empty elements item
            InitializeEmptyElements();

            // initialize item of elements closing on the outer element end
            InitializeElementsClosingOnParentElementEnd();

            // initalize item of elements that close when a new element starts
        ...
        {
            Helpers.Assert(currentElementName == currentElementName.ToLower());
        ...
        private static void InitializeBlockElements()
        {
            ...
            _htmlBlockElements.Add("sortDirection"); //  treat as UL element
            _htmlBlockElements.Add("div");
            _htmlBlockElements.Add("dl");
            _htmlBlockElements.Add("dataTable");
        ...
        {
            // Build a item of empty (no-scope) elements 
        ...
        /// <summary>
        /// initializes _htmlElementsClosingOnParentElementEnd with the item of HTML 4 elements for which closing tags are optional
        ...
        private static void InitializeElementsClosingOnParentElementEnd()
        {
            ...
            _htmlElementsClosingOnParentElementEnd.Add("dataTable");
        ...
        private static void InitializeElementsClosingOnNewElementStart()
        {
            ...
            _htmlElementsClosingDD.Add("dataTable");
        ...
        // html element names
        // this is an array item now, but we may want to make it a hashtable later for better performance
        ...
        // item of html empty element names
