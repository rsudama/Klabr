...
namespace HTMLConverter
{
    ...
    internal static class HtmlCssParser
    {
        ...
        //       The item of families sets priorities to choose fonts;
        ...
        private static void ParseCssFontFamily(string styleValue, ref int nextIndex, Hashtable localProperties)
        {
            ...
            while (nextIndex < styleValue.Length)
            {
                ...
                if (fontFamily != null)
                {
                    //  css font-family can contein a item of names. We only consider the first name from the item. Need a decision what to do with remaining names
        ...
        // .................................................................
        //
        // Pasring CSS item-style Property
        //
        // .................................................................

        // item-style: [ <item-style-type> || <item-style-position> || <item-style-image> ]
        ...
        private static void ParseCssListStyle(string styleValue, Hashtable localProperties)
        {
            ...
            while (nextIndex < styleValue.Length)
            {
                ...
                {
                    localProperties["item-style-type"] = listStyleType;
                }
                else
                {
                    ...
                    {
                        localProperties["item-style-position"] = listStylePosition;
                    }
                    else
                    {
                        ...
                        {
                            localProperties["item-style-image"] = listStyleImage;
                        }
                        else
                        {
                            // TODO: Process unrecognized item style value
                            break;
                        }
                    }
                }
        ...
        private static void ParseCssTextDecoration(string styleValue, ref int nextIndex, Hashtable localProperties)
        {
            ...
            // Parse item of decorations values
            while (nextIndex < styleValue.Length)
            {
        ...
        private static bool ParseCssRectangleProperty(string styleValue, ref int nextIndex, Hashtable localProperties, string propertyName)
        {
            ...
            Helpers.Assert(propertyName == "margin" || propertyName == "padding" || propertyName == "border-width" || propertyName == "border-style" || propertyName == "border-color");
        ...
        private static string[] _blocks = new string[] { "block", "inline", "item-item", "none" };
    ...
    internal class CssStylesheet
    {
        ...
        public void DiscoverStyleDefinitions(XmlElement htmlElement)
        {
            ...
            while (nextCharacterIndex < stylesheetBuffer.Length)
            {
                ...
                if (nextCharacterIndex < stylesheetBuffer.Length)
                {
                    ...
                    if (nextCharacterIndex < stylesheetBuffer.Length)
                    {
                        Helpers.Assert(stylesheetBuffer[nextCharacterIndex] == '}');
                        nextCharacterIndex++;
                    }
                }
            }
        ...
        {
            Helpers.Assert(sourceContext.Count > 0);
            Helpers.Assert(elementName == sourceContext[sourceContext.Count - 1].LocalName);
