...
namespace HTMLConverter
{
    ...
    internal class HtmlLexicalAnalyzer
    {
        ...
        {
            Helpers.Assert(_nextTokenType != HtmlTokenType.EOF);
            _nextToken.Length = 0;
        ...
        internal void GetNextEqualSignToken()
        {
            ...
            if (this.NextCharacter == '=')
            {
                // '=' is not in the item of entities, so no need to check for entities here
                this.GetNextCharacter();
            }
        }
        ...
        /// the item of combining characters in the XML documentation
        /// </summary>
        /// <param name="character">
        ...
        /// TODO: only a placeholder for now but later to be replaced with comparisons against
        /// the item of extenders in the XML documentation
        /// </summary>
        /// <param name="character">
        /// character to be checked
        /// </param>
        ...
        private void ReadDynamicContent()
        {
            ...
            Helpers.Assert(_previousCharacter == '<' && _nextCharacter == '!' && _lookAheadCharacter == '[');
        ...
        private void ReadUnknownDirective()
        {
            ...
            Helpers.Assert(_previousCharacter == '<' && _nextCharacter == '!' && !(_lookAheadCharacter == '-' || _lookAheadCharacter == '['));
        ...
        private void SkipProcessingDirective()
        {
            ...
            Helpers.Assert(_nextCharacter == '<' && _lookAheadCharacter == '?');
